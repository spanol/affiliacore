                  ...
                  <div className="bg-white dark:bg-neutral-900 border border-slate-100 dark:border-neutral-800 rounded-3xl flex flex-col shadow-sm overflow-hidden mb-20">
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full text-left">
                        <thead className="bg-glass-thead dark:bg-glass-thead-dark text-[10px] text-slate-400 dark:text-neutral-400 uppercase tracking-widest sticky top-0 backdrop-blur-glass-soft z-10 border-b border-slate-100 dark:border-neutral-800">
                          <tr>
