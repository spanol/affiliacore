...
export default function ClientDashboard() {
  ...
  return (
    <div className="space-y-8">
      <header>
        <h1 className="text-3xl font-light text-gray-900">Painel do Cliente</h1>
        <p className="text-gray-500 text-sm mt-1">Bem-vindo, {profile?.name}. Aqui estão as informações da sua rede.</p>
      </header>
        ...
        <div className="lg:col-span-2 space-y-6">
          <section className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm overflow-hidden relative">
            <div className="relative z-10">
              ...
              <h3 className="text-lg font-bold text-slate-800 mb-2">Informações da Conexão</h3>
